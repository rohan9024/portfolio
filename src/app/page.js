    ...
    <>
      ...
      <div className='w-screen dark:bg-black dark:text-white p-10'>
        ...
        <motion.div
          ...
          className=' flex md:justify-center items-center space-x-6 mt-10 md:p-10 md:ml-20 md:mr-20 md:space-x-20'>
          ...
          <div className={`${manrope.className} hidden md:flex md:justify-evenly md:items-center md:font-medium md:w-92 space-x-12`}>
            ...
            <a href="tel:9137244728" className=' transition ease-in  hover:text-gray-300  text-gray-500 duration-300 cursor-pointer'>Contact</a>
            {
              ...
              (<div
                ...
                className='transition ease-in  hover:text-gray-300  text-gray-500 duration-300 cursor-pointer hover:scale-105 hover:-translate-y-3' >
                <Image
                  src="/darkMode.png"
                  width={40}
                  height={40}
        ...
        <div className={`${manrope.className} flex flex-col justify-center items-center space-y-12 md:ml-44 md:mr-44 md:mt-64 mt-20 `}>
          ...
          <Link href="/netflix-clone" >
            <motion.div
              ...
              className='md:flex md:flex-row flex flex-col border border-gray-100 dark:border-gray-600 dark:hover:border-blue-600 transition ease-in-out duration-300  dark:hover:border-2 rounded-lg shadow-2xl md:w-[1140px] md:h-[489px] w-[300px] h-[370px] '>
              <Image
                src={netflix}
                width={667}
                height={457}
          ...
          <Link href="/examcell">
            <motion.div
              ...
              <div className={`${raleway.className} flex flex-col mx-6 my-4 md:w-1/4 justify-center space-y-4 `}>
                ...
                <h1 className='font-medium text-xl md:text-4xl'>Examcell for SIES GST</h1>
        ...
        <div className=' my-20 '>
          <Link href="/achievements" className='flex justify-center items-center ' >
            <h1 className={`${raleway.className} text-xl rounded-full border border-gray-600 px-6 py-2 transition ease-in-out  hover:bg-gray-300 dark:hover:bg-gray-900 duration-300 cursor-pointer`}>Browse achievements</h1>
          </Link>
        </div>
