      ...
      <div className='w-screen dark:bg-black dark:text-white p-10'>
        ...
        <motion.div
          ...
          <div className={`${manrope.className} hidden md:flex md:justify-evenly md:items-center md:font-medium md:w-92 space-x-12`}>
            <a href="https://drive.google.com/file/d/1-aYazGEtQyGtNaLtDeo3a1TWTvDnlPqL/view?usp=sharing" className='transition ease-in  hover:text-gray-300 text-gray-500 duration-150cursor-pointer '>Resume</a>
            <Link href="/experience" className=' transition ease-in  hover:text-gray-300  text-gray-500 duration-150cursor-pointer'>Experience</Link>
            <Link href="/achievements" className=' transition ease-in  hover:text-gray-300  text-gray-500 duration-150cursor-pointer'>Achievements</Link>
            <Link href="/about-me" className=' transition ease-in  hover:text-gray-300  text-gray-500 duration-150cursor-pointer'>About me</Link>
            <a href="tel:9137244728" className=' transition ease-in  hover:text-gray-300  text-gray-500 duration-150cursor-pointer'>Contact</a>
            {
              darkMode ?
          ...
          <Link href="/SIES-ERP">
            <motion.div
              ...
              <div className={`${raleway.className} flex flex-col mx-6 my-4 md:w-1/4 justify-center space-y-4 `}>
                ...
                <h1 className='font-medium text-sm md:text-lg text-blue-500'>FULL STACK DEVELOPMENT</h1>
                <h1 className='font-medium text-xl md:text-4xl'>ERP System for SIES GST</h1>
        ...
        <div className=' my-20 '>
          <Link href="/achievements" className='flex justify-center items-center ' >
            <h1 className={`${raleway.className} text-xl rounded-full border border-gray-600 px-6 py-2 transition ease-in-out  hover:bg-gray-300 dark:hover:bg-gray-900 duration-150cursor-pointer`}>Browse achievements</h1>
          </Link>
        </div>
      ...
      <div className='flex flex-col bg-blue-700 dark:bg-black dark:text-white border-t-2 border-blue-600'>
        ...
        <section className='flex flex-col md:mt-36 mt-14'>
          ...
          <section className='flex justify-center items-center my-4  '>
            <button onClick={() => router.push('mailto:rohanwandre24@gmail.com')} className={`${manrope.className} md:text-2xl text-lg font-bold rounded-full bg-yellow-400 dark:bg-blue-800 dark:hover:bg-blue-600 md:px-10 md:py-4 px-6 py-2 text-gray-800 dark:text-gray-400 transition ease-in-out  hover:-translate-y-1 hover:scale-110 hover:bg-yellow-500 duration-150`}>Send me an Email</button>
          </section>
          {/* Links */}
