...
function page() {
    ...
    return (
        <div className='w-screen h-auto flex flex-col dark:bg-black dark:text-white'>
            ...
            <div className='mt-20 md:mt-10 flex md:flex-row flex-col justify-center items-center space-y-6 md:space-y-0 shadow-lg border border-gray-300 bg-gray-100 dark:bg-black dark:border-gray-800 md:bg-transparent md:border-none md:shadow-none px-4 mx-4 py-12   rounded-lg'>
